...
<head>
  ...
  <title>ienti & manwere®</title>
  <meta name="description"
    content="ponte en contacto con ienti & manwere y solicita una consulta para comenzar tu viaje hacia tu crecimiento">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <!-- Favicon -->
  <link rel="shortcut icon" type="image/x-ico" href="assets/images/icon.ico">
  <!-- bootstrap CSS -->
  <link rel="stylesheet" defer href="assets/css/bootstrap.min.css" type="text/css" media="all" />
  <!-- carousel CSS -->
  <link rel="stylesheet" defer href="assets/css/owl.carousel.min.css" type="text/css" media="all" />
  <!-- animate CSS -->
  <link rel="stylesheet" defer href="assets/css/animate.css" type="text/css" media="all" />
  <!-- animated-text CSS -->
  <link rel="stylesheet" defer href="assets/css/animated-text.css" type="text/css" media="all" />
  <!-- font-awesome CSS -->
  <link rel="stylesheet" defer href="assets/css/all.min.css" type="text/css" media="all" />
  <!-- font-flaticon CSS -->
  <link rel="stylesheet" defer href="assets/css/flaticon.css" type="text/css" media="all" />
  <!-- theme-default CSS -->
  <link rel="stylesheet" defer href="assets/css/theme-default.css" type="text/css" media="all" />
  <!-- meanmenu CSS -->
  <link rel="stylesheet" defer href="assets/css/meanmenu.min.css" type="text/css" media="all" />
  <!-- Main Style CSS -->
  <link rel="stylesheet" defer href="style.css" type="text/css" media="all" />
  <!-- transitions CSS -->
  <link rel="stylesheet" defer href="assets/css/owl.transitions.css" type="text/css" media="all" />
  <!-- venobox CSS -->
  <link rel="stylesheet" defer href="venobox/venobox.css" type="text/css" media="all" />
  <!-- responsive CSS -->
  <link rel="stylesheet" defer href="assets/css/responsive.css" type="text/css" media="all" />
  <!-- modernizr js -->
  <script defer src="assets/js/vendor/modernizr-3.5.0.min.js"></script>
  <!-- bootstrap icons -->
  <link rel="stylesheet" defer href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.9.1/font/bootstrap-icons.css">
        ...
        <div class="col-lg-3">
          <div class="logo">
            ...
            <a class="main_sticky" href="index.html" title="ienti&manwere&circledR;">
              <img src="assets/images/logo2.webp" alt="logo" />
            </a>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-sm-12 col-md-6 col-lg-6 pl-0 pr-0">
          <div class="contact_from_box">
            <div class="contact_title pb-4">
              ...
              <p>Su dirección de correo electrónico no será utilizada para enviar publicidad</p>
            ...
            <form id="contact_form" action="assets/php/mail.php" method="POST">
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="form_box mb-30">
                    <input required type="text" name="telefono" id="telefono" placeholder="Número Telefónico *">
                  </div>
                </div>
                <div class="col-lg-12">
                  <div class="form_box mb-30">
                  ...
                  <div class="col-lg-12">
                    <div class="form_box mb-30">
                      <div class="g-recaptcha" data-sitekey="6Lfo4_QqAAAAAIzm1pDzrrw7QsYlBuFUr1D-9zgz" data-callback="enableSubmitBtn"></div>
                    </div>
                  </div>
                  <div class="quote_button">
                    <button id="submit-button" class="btn" disabled="disabled" type="submit"> <i class="bi bi-gear"></i> Cosultoria Gratuita </button>
                  </div>
                </div>
              </div>
            </form>
        ...
        <div class="col-sm-12 col-md-6 col-lg-6 pl-0 pr-0">
          <div class="cda-content-area">
            <div class="cda-content-title">
              <h3>Detalles de Contacto</h3>
              <p class="cda-content-text">No dude en contactarnos o visitarnos en cualquier momento.<br>Nos
                comprometemos a responder todas
                las consultas dentro de un plazo de 24 horas en días laborales.<br>Será un placer atender sus
                preguntas.</p>
            </div>
            <div class="cda-single-content d-flex">
              ...
              <div class="cda-content-inner">
                ...
                <p>CINTERMEX Avenida Fundidora 501, Local 129 C, <br>Colonia Obrera, Monterrey Nuevo León, CP 64010</p>
              </div>
            </div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12 p-0">
          <iframe title="Nuestra Direccion"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3595.7907514172807!2d-100.29055402386213!3d25.678230277404378!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8662942a8d42b18f%3A0x1eee54a9dfbc9332!2sCintermex!5e0!3m2!1ses-419!2smx!4v1741280473394!5m2!1ses-419!2smx"
            width="1920" height="350" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row footer-bg">
        <div class="col-lg-4 col-md-6 pl-0">
          <div class="widget widgets-company-info">
            ...
            <div class="follow-company-icon">
              <a class="social-icon-color" aria-label="enlace a nuestra pagina de facebook"
                href="https://www.facebook.com/ientimanwere"> <i class="bi bi-facebook"></i>
              </a>
              <a class="social-icon-color2" aria-label="enlace al perfil de linkedin de nuestro socio fundador"
                href="https://www.linkedin.com/in/raymundo-pav%C3%B3n-le%C3%B3n-6a3058151/">
                <i class="bi bi-linkedin"> </i> </a>
              <a class="social-icon-color1" aria-label="Enlace a nuestro perfil de x" href="https://x.com/ienti_ti"> <i
                  class="fa-brands fa-x-twitter"></i> </a>
              <a class="social-icon-color3" aria-label="Enlace a nuestro youtube"
                href="https://www.youtube.com/user/ientiConsultoria"> <i class="bi bi-youtube"></i> </a>
            </div>
          </div>
        </div>
        ...
        <div class="foorer-shape">
          <div class="footer-thumb">
            <img src="assets/images/resource/red-dot.webp" alt="">
          </div>
          <div class="footer-thumb1 bounce-animate2">
            <img src="assets/images/resource/all-shape.webp" alt="">
          </div>
        </div>
      </div>
    </div>
